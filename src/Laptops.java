...
public class Laptops extends JFrame{
    ...
    private void initActionListeners() {
        addToCartButton1.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l1.getText(), 1, 100000);
            addCart(newItem);
        ...
        addToCartButton2.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l2.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        addToCartButton3.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l3.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        addToCartButton4.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l4.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        addToCartButton5.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l5.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        addToCartButton6.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l6.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        addToCartButton7.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l7.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
        addToCartButton8.addActionListener(e -> {

            CartItem newItem = new CartItem(l8.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        addToCartButton9.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l9.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
        ...
        addToCartButton10.addActionListener(e -> {
            ...
            CartItem newItem = new CartItem(l10.getText(), 1, 100000);
            addCart(newItem);
            JOptionPane.showMessageDialog(this, "Item added to cart", "Cart", JOptionPane.INFORMATION_MESSAGE);
        });
    ...
    public static void main(String[] args) {
        ...
        lp.setContentPane(lp.MainLP);
        lp.setSize(300,400);
        lp.setTitle("SSM - Laptops");
        ImageIcon img = new ImageIcon("./logo.png");
        lp.setIconImage(img.getImage());
